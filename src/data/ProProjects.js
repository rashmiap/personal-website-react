...
export default [
	...
	},
	{
		...
		icon: dare,
		description:
			"Dare is a feature on the Zoojoobe platform developed in ReactJS that primarily focuses on the competitive behaviour of the users. Two users compete with each other to complete a particular healthy task. Meanwhile other users within the corporate can motivate the user using the cheer function.",
		githubPath: null,
		demoPath: null,
		year: "2017",
	...
	},
	{
		...
		icon: pregnancy,
		description:
			"Maternity module was primarily designed for the women within a corporate. The feature takes into account the user's due date based on which it recommends articles and relevant mindfulness tracks. This feature helps them stay healthy throughout the process.",
		githubPath: null,
		demoPath: null,
		year: "2017",
