...
export default [
    ...
    },
    {
        ...
        icon: website,
        description: "Zoojoobe is a game based social wellness platform that unites the workforce to form healthier habits. The platform leverages on the tremendous power of the trusted social network at our workplace to motivate employees to form healthier habits. Developed the sales website on wordpress.(2017)",
        githubPath: null,
